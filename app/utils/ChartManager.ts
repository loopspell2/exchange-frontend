import { ISeriesApi, createChart as createLightweightChart, CrosshairMode, ColorType, UTCTimestamp } from "lightweight-charts";
...
export class ChartManager {
    ...
    constructor(ref: any, intialData: any[], layout: { background: string, color: string }) {
